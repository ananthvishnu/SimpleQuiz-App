(function(){
    ...
    const myQuestions = [
      ...
      {
        question: "Which html attribute is used to referrance and external in javascript file? ",
        answers: {
          a: "src",
          b: "rel",
          c: "type",
      ...
      {
        question: "A variable in javascript must start with wich special character?",
        answers: {
          a: "@",
          b: "$",
          c: "#",
